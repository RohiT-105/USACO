...
void solve() 
{
    ...
    if(xb==xl && xb==xr && ((yr<yb && yr>yl)||(yr<yl && yr>yb))) cout<<abs(yb-yl)+1;
    else if(yb==yl && yb==yr && ((xr<xb && xr>xl)||(xr<xl && xr>xb))) cout<<abs(xb-xl)+1;
    else cout<<abs(yb-yl)+abs(xb-xl)-1;
    // cout<<yb-yl;
}
signed main()
{
